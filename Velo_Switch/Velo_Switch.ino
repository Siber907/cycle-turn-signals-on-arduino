...
{ 
  ...
  {
    LeftState = TURN_OFF;
    PCintPort::detachInterrupt(TURN_LEFT_PIN);
    PCintPort::attachInterrupt(TURN_LEFT_PIN, &KeyLeft_ISR, FALLING);
  }
  else
  {
    ...
    TurnRightReset();
    PCintPort::detachInterrupt(TURN_LEFT_PIN);
    PCintPort::attachInterrupt(TURN_LEFT_PIN, &KeyLeft_ISR, RISING);
  }
}
//----------------------------------------
void KeyRight_ISR()
{ 
  ...
  {
    RightState = TURN_OFF;
    PCintPort::detachInterrupt(TURN_RIGHT_PIN);
    PCintPort::attachInterrupt(TURN_RIGHT_PIN, &KeyRight_ISR, FALLING);
  }
  else
  {
    ...
    TurnLeftReset();
    PCintPort::detachInterrupt(TURN_RIGHT_PIN);
    PCintPort::attachInterrupt(TURN_RIGHT_PIN, &KeyRight_ISR, RISING);
  }
}
