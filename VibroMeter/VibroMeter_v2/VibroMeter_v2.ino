...
#define   FREE_FALL_ACCEL          ((float) 9.6)
#define   ACCEL_THRESHOLD          ((float) 1)
...
#define   FREE_FALL_COLOR          ((uint32_t) 0x05000001)
#define   LOW_VIBRATION_COLOR      ((uint32_t) 0x00002200)
#define   MEDIUM_VIBRATION_COLOR   ((uint32_t) 0x00191900)
#define   HIGH_VIBRATION_COLOR     ((uint32_t) 0x00290000)
#define   PEAK_LED_COLOR           ((uint32_t) 0x00290000)

#define   MEDIUM_VIBRATION_ZONE_START   15
#define   HIGH_VIBRATION_ZONE_START     17

#define   ACCEL_VALUE_PER_PIXEL         ((float) 0.4)//((float) 1.5)
#define   SCALE_SHOW_DELAY              ((uint16_t) 40)//mc
...
void loop()
{
  if (VibroScale.ActiveLEDs == VibroScale.MaximumLeds)
  {
    ...
    {
      if (AccelResultNew < FREE_FALL_LOW_THRESHOLD)
        AccelResultNew = FREE_FALL_LOW_THRESHOLD - AccelResultNew;
      else
        AccelResultNew -= FREE_FALL_HIGH_THRESHOLD;
